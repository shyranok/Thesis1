...
#Code from: https://stackoverflow.com/questions/71420952/modulenotfounderror-no-module-named-python
import sys,os
...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.E = nn.Sequential(
            ...
            nn.BatchNorm2d(256),
            nn.LeakyReLU(0.1, True),
            nn.AdaptiveAvgPool2d(1), #256 channels output
        )
    ...
    def forward(self, x):
        fea = self.E(x).squeeze(-1).squeeze(-1) #256, 
        out = self.mlp(fea)
